...
def getProbData(link, index1):
    try:
        ...
        if(head.text):
            ...
            create_file_add_text(str(index1), body.text)
        time.sleep(1)
        return True
